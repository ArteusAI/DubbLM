...
import { DEFAULT_PERSONAS, PRESETS, normalizeTtsSystem } from './constants';
...
const INITIAL_CONFIG: AppConfig = {
  ...
  personaId: DEFAULT_PRESET.personaId || 'none',
  ...
  enableLlmEditor: DEFAULT_PRESET.enableLlmEditor,
  enableLlmTextAdjustment: DEFAULT_PRESET.enableLlmTextAdjustment,
  editorLlmProvider: DEFAULT_PRESET.editorLlmProvider,
  editorModelName: DEFAULT_PRESET.editorModelName,
  editorTemperature: DEFAULT_PRESET.editorTemperature,
  editorReasoningEffort: DEFAULT_PRESET.editorReasoningEffort,
  ...
  enableContextStyle: DEFAULT_PRESET.enableContextStyle,
  contextStyleMaxChars: DEFAULT_PRESET.contextStyleMaxChars,
  dubbedVolume: DEFAULT_PRESET.dubbedVolume,
  backgroundVolume: DEFAULT_PRESET.backgroundVolume,
  normalizeAudio: DEFAULT_PRESET.normalizeAudio,
...
const buildProjectConfigPayload = (
  ...
  enableLlmEditor: cfg.enableLlmEditor,
  enableLlmTextAdjustment: cfg.enableLlmTextAdjustment,
  editorLlmProvider: cfg.editorLlmProvider,
  editorModelName: cfg.editorModelName,
  editorTemperature: cfg.editorTemperature,
  editorReasoningEffort: cfg.editorReasoningEffort,
  ...
  enableContextStyle: cfg.enableContextStyle,
  contextStyleMaxChars: cfg.contextStyleMaxChars,
  contentValidatorProvider: cfg.contentValidatorProvider,
  contentValidatorWhisperModel: cfg.contentValidatorWhisperModel,
  contentValidatorWhisperComputeType: cfg.contentValidatorWhisperComputeType,
  contentValidatorWhisperCpuThreads: cfg.contentValidatorWhisperCpuThreads,
  contentValidatorSpeechModel: cfg.contentValidatorSpeechModel,
...
const mapSegmentFromApi = (
  ...
  provider: normalizeTtsSystem(seg.provider || fallback?.ttsSystem || 'openai').ttsSystem || 'openai',
...
const mapProjectFromApi = (p: ProjectResponse): Project => {
  ...
  return {
    ...
    config: {
      ...
      personaId: cfg.personaId || preset.personaId || 'normal',
      speakerCount: cfg.speakerCount,
      ...
      enableLlmEditor: cfg.enableLlmEditor ?? preset.enableLlmEditor,
      enableLlmTextAdjustment: cfg.enableLlmTextAdjustment ?? preset.enableLlmTextAdjustment,
      editorLlmProvider: (cfg.editorLlmProvider as LlmProvider) || preset.editorLlmProvider,
      editorModelName: cfg.editorModelName || preset.editorModelName,
      editorTemperature: cfg.editorTemperature ?? preset.editorTemperature,
      editorReasoningEffort: cfg.editorReasoningEffort ?? preset.editorReasoningEffort,
      ...
      ...normalizeTtsSystem(
        cfg.ttsSystem || preset.ttsSystem,
        cfg.ttsModel || preset.ttsModel,
      ),
      ...
      enableContextStyle: cfg.enableContextStyle ?? preset.enableContextStyle,
      contextStyleMaxChars: cfg.contextStyleMaxChars ?? preset.contextStyleMaxChars,
      contentValidatorProvider: cfg.contentValidatorProvider ?? 'whisper',
      contentValidatorWhisperModel: cfg.contentValidatorWhisperModel ?? 'base',
      contentValidatorWhisperComputeType: cfg.contentValidatorWhisperComputeType ?? 'int8',
      contentValidatorWhisperCpuThreads: cfg.contentValidatorWhisperCpuThreads ?? 2,
      contentValidatorSpeechModel: cfg.contentValidatorSpeechModel ?? 'nano',
      dubbedVolume: cfg.dubbedVolume ?? preset.dubbedVolume,
      backgroundVolume: cfg.backgroundVolume ?? preset.backgroundVolume,
      normalizeAudio: cfg.normalizeAudio ?? preset.normalizeAudio,
      keepOriginalAudioRanges: cfg.keepOriginalAudioRanges || [],
...
const App: React.FC = () => {
  ...
  const handleChangePreset = async (projectId: string, presetId: PresetId) => {
    try {
      ...
      const configUpdate = {
        preset: presetId,
        personaId: presetFromApi?.personaId ?? preset.personaId ?? (presetId === 'ultra' ? 'normal' : 'none'),
