...
def _project_to_response(project: Project, include_segments: bool = False) -> dict:
    ...
    response = {
        ...
        "config": ProjectConfig(
            ...
            enableLlmEditor=config.get("enableLlmEditor"),
            editorLlmProvider=config.get("editorLlmProvider"),
            editorModelName=config.get("editorModelName"),
            editorTemperature=config.get("editorTemperature"),
            editorReasoningEffort=config.get("editorReasoningEffort"),
